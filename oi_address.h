...
static inline int address4_create(address_t * a, unsigned char * ip, uint16 port) {
...
static inline int address4_create(address_t * a, char * s) {
	return inet_pton(AF_INET,s,&a->ipv4.sin_addr) != -1;
}

static inline int address6_create(address_t * a, unsigned char * ip, uint16 port) {
...
static inline int address6_create(address_t * a, char * s) {
